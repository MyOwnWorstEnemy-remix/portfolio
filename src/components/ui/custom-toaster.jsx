...
function CustomToaster ({tst, text}) {
    return (
        <div 
            className="rounded-xl flex items-center gap-3 px-5 py-7 cursor-pointer bg-[#ff000020] dark:bg-[#111111] border border-[#ff0000]/40 dark:border-[#00eeff]/50 text-[#ff0000]/40 dark:text-[#00eeff]/50 hover:text-[#ff0000]/70 dark:hover:text-[#00eeff]/70"
